...
```bash
cookiecutter gh:asjustin83/cookiecutter-datascience-simple
```
...
For the remote repository, make a github repository named taxinfo, then do;

```bash
git remote add origin git@github.com:asjustin83/taxinfo.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── taxinfo	<- Your notebooks and scripts will live in the main project folder
